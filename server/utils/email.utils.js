...
// Sending a Deadline Email Reminder
export const sendDeadlineReminder = async (studentEmail, studentName, scholarship, daysLeft) => {
    try {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="background: #f5f5f5; padding: 15px; border-radius: 8px;">
                        <h3 style="color: #333;">${scholarship.title}</h3>
                        <p><strong>Provider:</strong> ${scholarship.provider}</p>
                        <p><strong>Deadline:</strong> ${new Date(scholarship.dates.deadline).toDateString()}</p>
                        <p><strong>Days Left:</strong> ${daysLeft} days</p>
                        <p><strong>Amount:</strong> ${scholarship.funding.amountDisplay || 'See link'}</p>
                    </div>
                    ...
                    <p style="color: #888; font-size: 12px;">
                        This is an automated reminder from UniSave Sacco.
